...
-------------------------------
-- NHANVIEN
insert into nhanvien values('NV01',N'Nguyễn Lê Nhựt','nhut@gmail.com',N'34/34B Nguyễn Tri Phương, Q7, TpHCM','927345678','13/04/2000','18/02/2020')
insert into nhanvien values('NV02',N'Lê Thị Phi Yến','yen@gmail.com',N'322 Lý Tự Trọng, Q1, TpHCM','987567390','21/04/2000','11/07/2020')
insert into nhanvien values('NV03',N'Nguyễn Văn Bằng','bang@gmail.com',N'111 Nguyễn Trãi, Q1, TpHCM','997047382','27/04/2000','15/05/2020')
insert into nhanvien values('NV04',N'Ngô Thành Tuấn','tuan@gmail.com',N'34 Nguyễn Hữu Cầu, Q2, TpHCM','913758498','24/06/2000','11/08/2020')
insert into nhanvien values('NV05',N'Trần Xuân Sơn','son@gmail.com',N'777 Nguyễn Trãi, Q1, TpHCM','918590387','20/07/2006','11/09/2020')
------------------------------
--USER
...
insert into sanpham values('SP01N39J','Jordan','Jordan MAX 720 39N',39,'Nam',300000,10,'img-6827.jpg_v=1596895096000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP01N37J','Jordan','Jordan MAX 720 37N',37,'Nam',300000,10,'119549718-1698416293656862-8026301910009318647-o.jpg_v=1600668558000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP01N38J','Jordan','Jordan MAX 720 38Nu',38,N'Nữ',350000,10,'125185374-1749526221879202-1018442684144882496-o.jpg_v=1605695505000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP02N38N','Nike','Nike MAX 720 38N',38,'Nam',350000,10,'img-8167.jpg_v=1599297027000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP02N39N','Nike','Nike MAX 720 39Nu',39,N'Nữ',350000,10,'img-7120.jpg_v=1597819777000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP03N38C','Converse','Converse MAX 720 38N',38,'Nam',350000,10,'img-4065.jpg_v=1582104173000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP03N37C','Converse','Converse MAX 720 37Nu',37,'Nữ',350000,10,'84858282-1499681206863706-4696649297700061184-o.jpg_v=1581227427000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP03N39C','Converse','Converse MAX 720 40N',39,'Nam',350000,10,'73458865-978164459207756-5590840336013328384-n.jpg_v=1573471781000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP04Nu38P','Puma','Puma MAX 720 38Nu',38,N'Nữ',350000,10,'img-6837.jpg_v=1596894316000.jpg',N'Hàng chất lượng cao')
insert into sanpham values('SP04N38P','Puma','Puma MAX 720 39N',38,'Nam',350000,10,'88169086-1516504355181391-2844007342024949760-o-cc6783af-dd44-4a25-9f13-9f8af171d02a.jpg_v=1592559570000.jpg',N'Hàng chất lượng cao')
